...
class ImenikTest {
    ...
    void dodaj() {
        ...
        MobilniBroj mirna=new MobilniBroj(62, "206-266");
        imenik.dodaj("Mirna Kavcic", mirna);
        assertEquals("Mirna Kavcic", imenik.dajIme(mirna));
        assertEquals("062/206-266", imenik.dajBroj("Mirna Kavcic"));
    }
